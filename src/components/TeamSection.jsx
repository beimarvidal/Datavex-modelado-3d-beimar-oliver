...
export default function TeamSection() {
  return (
    <section id="equipo" className="bg-slate-950 px-6 py-24 text-white">
      <div className="mx-auto max-w-7xl">
        <div className="mb-14 text-center">
          <p className="mb-4 text-cyan-300">Equipo</p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {team.map((member, index) => {
            ...
            return (
              ...
              >
                <div className="mb-6 grid h-16 w-16 place-items-center rounded-2xl bg-cyan-400 text-slate-950">
                  <Icon size={30} />
                </div>

                <h3 className="text-2xl font-black">{member.name}</h3>
                <p className="mt-3 text-cyan-300">{member.role}</p>
              </motion.div>
            )
          })}
        </div>
